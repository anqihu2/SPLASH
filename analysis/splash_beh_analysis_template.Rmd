...
adult_demo <- read.csv("/Users/jojohu/Documents/Splash/beh_analysis/demo/MINDSPLASH-Smilemedaladultdob_DATA_2023-02-23_1302.csv")
...
# Merge retention accuracy with immediate recall accuracy
```{r}
merge(blockRe, imm)
```
...
simple_allReTD2 <- glmer(corr ~ social_cond*scaled_age*test_three + 
                          (1 + social_cond|Participant.Public.ID) + (1+social_cond|story),
                    data = allReTD,
                    family = binomial,
                    contrasts = list(
...
simple_allReASD2 <- glmer(corr ~ social_cond*scaled_age*test_three + 
                          (1 + social_cond|Participant.Public.ID) + (1+social_cond|story),
                    data = allReASD,
                    family = binomial,
                    contrasts = list(
